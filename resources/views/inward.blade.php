...
<section class="body-content">
    <div class="container mt-2 ">
        <h6 class="text-center mt-2"><b>Add Inward</b></h6>
        @if ($errors->any())
        <ul>
        ...
        @endif
        <form name="frmInward" id="frmInward" method="post" action="addInward">
            <div class="d-flex justify-content-center">
                <div class="row filter_form col-11 border border-1 mt-2">
    ...
    <div class="container-fluid">
        <span class="badge badge-primary p-2  badge-pill mb-3"><b>Inward List</b></span>
        <div class="row">
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <form name="frmInwardUpdate" id="frmInwardUpdate" method="post" action="updateInward">
                    <div class="row p-2">
                        <div class="col form-group">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(tt, function(key, value) {
                     data.push({label:value.item_name, value: value.item_code});
